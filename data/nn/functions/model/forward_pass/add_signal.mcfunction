...
$execute if score .visualize settings matches 1 unless score .temp global matches -99..99 anchored feet facing entity @e[type=marker,tag=$(prev_layer),tag=$(from),limit=1,sort=nearest] feet run function nn:model/display/weight/draw_line
