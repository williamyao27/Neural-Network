# Computes an approximation of e^var_exp and stores it in var_dest. Works for var_exp up to around e^12.25 (or in scoreboard form, e^122500)

# Initialize exponent loop by setting it to the given exponent
$scoreboard players operation .exponent euler = $(var_exp) $(obj_exp)

# Initialize the destination with the value 1.0000, equal to e^0
