# Divides var1 obj1 by var2 obj2. Ideally this should use the scale factor, but we will use x100 both ways as empirically this
# hits the ceiling of the scoreboard less frequently.
