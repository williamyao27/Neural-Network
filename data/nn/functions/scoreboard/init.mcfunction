...
scoreboard players set .hidden1_to global 16
scoreboard players set .hidden2_from global 16
scoreboard players set .hidden2_to global 8
scoreboard players set .output_from global 8
