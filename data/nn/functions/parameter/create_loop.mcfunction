...
$execute if score .create_parameter_loop_from global < .$(layer)_from hyperparameter run return run function nn:parameter/create_loop with storage nn:helpers
...
$execute if score .create_parameter_loop_to global = .$(layer)_to hyperparameter run return 0
